      ...
      <div className="container">
        <div className="row">
          ...
          >
            ...
            <p>
              I’m a web developer and designer who always likes to learn new
              things. I’m self-sufficient but collaborate well with others. I've
              been working in the field of web development for 10 years and I
              love seeking out opportunities that will not only challenge me but
              will also allow me to expand my skill set and further my career.
            </p>
          </div>
        </div>
      </div>

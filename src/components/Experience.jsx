      ...
      <div className="container">
        <VerticalTimeline>
          <VerticalTimelineElement
            ...
            contentArrowStyle={{
              borderRight: "7px solid  var(--primary-white)",
            }}
          ...
          >
            ...
            <p>
              <span>
                HTML | CSS | Tailwind | Adobe Illustrator | Adobe Photoshop |
                JobSuite
              </span>
            </p>
          </VerticalTimelineElement>
          ...
          >
            ...
            <p>
              <span>
                HTML | CSS | Adobe Illustrator | Adobe Photoshop | Jira | Sketch
                | Invision
              </span>
            </p>
          </VerticalTimelineElement>
          ...
          >
            ...
            <p>
              <span>
                HTML | CSS | JavaScript | jQuery | Bootstrap | Jira | Adobe

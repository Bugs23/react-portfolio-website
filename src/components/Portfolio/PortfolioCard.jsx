	...
	return (
		<div className={`portfolio-card pt-4 ${props.reverse ? 'reverse' : ''}`}>
            <div className="portfolio-card-item-1">
                <div className={`project-image-container pb-3 ${inView1 ? 'bounce-in-right' : 'hidden-effect'}`} ref={ref1}>
            ...
            <div className={`portfolio-card-item-2 ${inView2 ? 'bounce-in-left' : 'hidden-effect'}`} ref={ref2}>
                <div className="portfolio-project-text pb-5 center-text">
                    ...
                    <div className="portfolio-btn-container">
                        {props.repoUrl && <a href={props.repoUrl} rel="noreferrer" target="_blank"  className="btn-main portfolio-btn">Source Code</a>}
                        {props.demoUrl && <a href={props.demoUrl} rel="noreferrer" target="_blank"  className="btn-secondary portfolio-btn">Website</a>}
                    </div>
